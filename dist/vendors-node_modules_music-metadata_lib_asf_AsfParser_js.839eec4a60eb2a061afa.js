"use strict";
(self["webpackChunkhousegramx"] = self["webpackChunkhousegramx"] || []).push([["vendors-node_modules_music-metadata_lib_asf_AsfParser_js"],{
...
class GUID {
    ...
    static decode(objectId, offset = 0) {
        ...
        const guid = `${view.getUint32(0, true).toString(16)}-${view.getUint16(4, true).toString(16)}-${view.getUint16(6, true).toString(16)}-${view.getUint16(8).toString(16)}-${(0,uint8array_extras__WEBPACK_IMPORTED_MODULE_0__.uint8ArrayToHex)(objectId.subarray(offset + 10, offset + 16))}`;
    ...
    static encode(str) {
        ...
        bin.set((0,uint8array_extras__WEBPACK_IMPORTED_MODULE_0__.hexToUint8Array)(str.substring(19, 23)), 8);
        bin.set((0,uint8array_extras__WEBPACK_IMPORTED_MODULE_0__.hexToUint8Array)(str.substring(24)), 10);
        return bin;
    }
    constructor(str) {
        this.str = str;
...
//# sourceMappingURL=vendors-node_modules_music-metadata_lib_asf_AsfParser_js.839eec4a60eb2a061afa.js.map
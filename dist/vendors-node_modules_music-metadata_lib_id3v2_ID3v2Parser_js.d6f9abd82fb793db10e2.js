"use strict";
(self["webpackChunkhousegramx"] = self["webpackChunkhousegramx"] || []).push([["vendors-node_modules_music-metadata_lib_id3v2_ID3v2Parser_js"],{
...
class FrameParser {
    ...
    readData(uint8Array, type, includeCovers) {
        ...
        switch (type !== 'TXXX' && type[0] === 'T' ? 'T*' : type) {
            ...
            case 'PCST': {
                let text;
                try {
                    text = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(1), encoding).replace(/\x00+$/, '');
                }
                catch (error) {
            ...
            case 'APIC':
                if (includeCovers) {
                    ...
                    switch (this.major) {
                        case 2:
                            pic.format = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(offset, offset + 3), 'latin1'); // 'latin1'; // latin1 == iso-8859-1;
                            offset += 3;
                            break;
                        case 3:
                        case 4:
                            fzero = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.findZero(uint8Array, offset, length, defaultEnc);
                            pic.format = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(offset, fzero), defaultEnc);
                            offset = fzero + 1;
                            break;
                        default:
                    ...
                    pic.description = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(offset, fzero), encoding);
            ...
            case 'POPM': { // Popularimeter
                fzero = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.findZero(uint8Array, offset, length, defaultEnc);
                const email = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(offset, fzero), defaultEnc);
                offset = fzero + 1;
                const valueLen = length - offset - 1;
                output = {
                    email,
                    rating: token_types__WEBPACK_IMPORTED_MODULE_1__.UINT8.get(uint8Array, offset),
                    counter: valueLen > 0 ? _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeUintBE(uint8Array.subarray(offset + 1)) : undefined
                };
                break;
            }
            case 'GEOB': { // General encapsulated object
                fzero = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.findZero(uint8Array, offset + 1, length, encoding);
                const mimeType = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(offset + 1, fzero), defaultEnc);
                offset = fzero + 1;
                fzero = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.findZero(uint8Array, offset, length, encoding);
                const filename = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(offset, fzero), defaultEnc);
                offset = fzero + 1;
                fzero = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.findZero(uint8Array, offset, length, encoding);
                const description = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(offset, fzero), defaultEnc);
                offset = fzero + 1;
                const geob = {
                    type: mimeType,
                    filename,
            ...
            case 'WPUB':
                // Decode URL
                fzero = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.findZero(uint8Array, offset + 1, length, encoding);
                output = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(offset, fzero), defaultEnc);
                break;
            case 'WXXX': {
                // Decode URL
                fzero = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.findZero(uint8Array, offset + 1, length, encoding);
                const description = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(offset + 1, fzero), encoding);
                offset = fzero + (encoding === 'utf-16le' ? 2 : 1);
                output = { description, url: _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(offset, length), defaultEnc) };
                break;
            }
            case 'WFD':
            case 'WFED':
                output = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(offset + 1, _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.findZero(uint8Array, offset + 1, length, encoding)), encoding);
                break;
            case 'MCDI': {
                // Music CD identifier
    ...
    static readIdentifierAndData(uint8Array, offset, length, encoding) {
        ...
        const id = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(offset, fzero), encoding);
...
class ID3v2Parser {
    ...
    readFrameHeader(uint8Array, majorVer) {
        ...
        switch (majorVer) {
            case 2:
                header = {
                    id: (0,_borewit_text_codec__WEBPACK_IMPORTED_MODULE_4__.textDecode)(uint8Array.subarray(0, 3), 'ascii'),
            ...
            case 4:
                header = {
                    id: (0,_borewit_text_codec__WEBPACK_IMPORTED_MODULE_4__.textDecode)(uint8Array.subarray(0, 4), 'ascii'),
...
//# sourceMappingURL=vendors-node_modules_music-metadata_lib_id3v2_ID3v2Parser_js.d6f9abd82fb793db10e2.js.map
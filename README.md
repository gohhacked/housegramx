...
HouseGramX is a custom Telegram web client based on Telegram Web A, which won the first prize 🥇 at [Telegram Lightweight Client Contest](https://contest.com/javascript-web-3).

This project is built on the [Teact](https://github.com/Ajaxy/teact) framework and uses a custom version of [GramJS](https://github.com/gram-js/gramjs) as an MTProto implementation.
